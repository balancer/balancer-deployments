...
describeForkTest.skip('BatchRelayerLibrary V6 - ERC4626Wrapping', 'mainnet', 18412883, function () {
  let task: Task;
  ...
  it('should wrap successfully', async () => {
    ...
    await (relayer.connect(sender) as Contract).multicall([depositIntoUSDM]);
