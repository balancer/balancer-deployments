...
export type ProtocolFeeHelperDeployment = {
  Vault: string;
  HelperAdmin: string;
};
...
// See https://github.com/balancer/bal_addresses/blob/b155d7ef5ea0521e3517213912ce103e48222360/outputs/addressbook.json#L339
