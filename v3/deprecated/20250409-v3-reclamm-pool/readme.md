...
>
> This version was superseded by [`ReClamm V2`](../20250702-v3-reclamm-pool-v2/), which implements better guardrails against edge cases and stricter limits for admin settings. This factory can still be used, although high centeredness margins (> 90%) and high shift daily rates (> 100%) are discouraged.
