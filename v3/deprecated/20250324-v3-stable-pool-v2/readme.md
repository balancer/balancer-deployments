...
>
> This pool factory has been superseded by [stable pool V3](../../tasks/20260116-v3-stable-pool-v3/), which has stability improvements, a longer pause window and allows setting a pool creator.
