# 2023-05-24 - LayerZero OmniVotingEscrowChild

Deployment of the `OmniVotingEscrowChild`, which receives veBAL balances in child chains from LayerZero endpoints.
