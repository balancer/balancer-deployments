...
const OldGaugeAdder = new Task('20230109-gauge-adder-v3', TaskMode.READ_ONLY);
const NewGaugeAdder = new Task('20230519-gauge-adder-v4', TaskMode.READ_ONLY);
...
const GnosisRootGaugeFactory = new Task('20230217-gnosis-root-gauge-factory', TaskMode.READ_ONLY);
const PolygonZkEVMRootGaugeFactory = new Task('20230526-zkevm-root-gauge-factory', TaskMode.READ_ONLY);
